...
test.describe("Comprehensive Application Test Suite", () => {
  ...
  test("Field Tools: A2L Safety Calculator", async ({ page }) => {
    ...
    await expect(
      page.locator("text=A2L Charge Limit Calculator"),
    ).toBeVisible();

    // Inputs
    await page.getByText("Room Area").locator("..").locator("input").fill("50");
    await page
      .getByText("Install Height")
      .locator("..")
      .locator("input")
      .fill("2.5");
  ...
  test("Field Tools: Subcooling Calculator", async ({ page }) => {
    ...
    await expect(
      page.getByRole("heading", { name: "Target Subcooling" }).first(),
    ).toBeVisible();

    // Inputs
    await page
      .getByText("Target Subcooling")
      .locator("..")
      .locator("input")
      .fill("10");
    await page
      .getByText("Liquid Line Pressure")
      .locator("..")
      .locator("input")
      .fill("318");
    await page
      .getByText("Liquid Line Temperature")
      .locator("..")
      .locator("input")
      .fill("90");
    ...
    await expect(
      page.getByRole("heading", { name: "Actual Subcooling" }),
    ).toBeVisible();
  ...
  test("Field Tools: Psychrometric Superheat", async ({ page }) => {
    ...
    // Inputs: IDWB, ODDB
    await page
      .getByText("Indoor Wet Bulb")
      .locator("..")
      .locator("input")
      .fill("65");
    await page
      .getByText("Outdoor Dry Bulb")
      .locator("..")
      .locator("input")
      .fill("95");

    await expect(
      page.getByRole("heading", { name: "Target Superheat" }).last(),
    ).toBeVisible();
