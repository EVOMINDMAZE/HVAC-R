-- Fix ambiguous column reference "role" in get_user_companies_v2 function
-- The column "role" in the SELECT clause was ambiguous between the CTE column
-- and the table column from the joined user_roles table
