...
\restrict MNnU8oxy3ugJD6h157exHhJhtcIf2wlwbtDTfCAkQteia4zfXp059x90BPWMnTm
...
CREATE FUNCTION public.audit_log_role_assigned() RETURNS trigger
    LANGUAGE plpgsql
    AS $$
BEGIN
...
CREATE FUNCTION public.audit_log_role_changed() RETURNS trigger
    LANGUAGE plpgsql
    AS $$
BEGIN
...
CREATE FUNCTION public.audit_log_role_removed() RETURNS trigger
    LANGUAGE plpgsql
    AS $$
BEGIN
    PERFORM public.log_audit_event(
...
CREATE FUNCTION public.check_seat_limit(p_company_id uuid DEFAULT NULL::uuid) RETURNS jsonb
...
CREATE FUNCTION public.check_user_can_access_company(p_company_id uuid) RETURNS jsonb
    LANGUAGE plpgsql SECURITY DEFINER
    AS $$
DECLARE
...
CREATE FUNCTION public.company_requires_skool(p_company_id uuid DEFAULT NULL::uuid) RETURNS boolean
    LANGUAGE plpgsql SECURITY DEFINER
    AS $$
DECLARE
    v_requires BOOLEAN;
...
CREATE FUNCTION public.create_invitation_link(p_company_id uuid, p_role text, p_expires_at timestamp with time zone DEFAULT (now() + '30 days'::interval), p_max_uses integer DEFAULT 1) RETURNS jsonb
    LANGUAGE plpgsql SECURITY DEFINER
    AS $$
DECLARE
    v_slug TEXT;
...
CREATE FUNCTION public.create_job_from_alert() RETURNS trigger
    LANGUAGE plpgsql SECURITY DEFINER
    AS $$
DECLARE
    v_client_id UUID;
...
CREATE FUNCTION public.debug_get_companies(target_user_id uuid) RETURNS TABLE(company_id uuid, company_name text, role text)
    LANGUAGE plpgsql SECURITY DEFINER
...
CREATE FUNCTION public.get_company_audit_logs(p_company_id uuid DEFAULT NULL::uuid, p_limit integer DEFAULT 50, p_offset integer DEFAULT 0) RETURNS TABLE(id uuid, user_id uuid, action text, entity_type text, entity_id uuid, details jsonb, created_at timestamp with time zone)
    LANGUAGE plpgsql SECURITY DEFINER
    AS $$
BEGIN
    RETURN QUERY
...
CREATE FUNCTION public.get_company_settings(p_company_id uuid DEFAULT NULL::uuid) RETURNS jsonb
    LANGUAGE plpgsql SECURITY DEFINER
    AS $$
DECLARE
    v_company_id UUID;
...
CREATE FUNCTION public.get_company_subscription(p_company_id uuid DEFAULT NULL::uuid) RETURNS jsonb
    LANGUAGE plpgsql SECURITY DEFINER
    AS $$
DECLARE
    v_company_id UUID;
...
CREATE FUNCTION public.get_company_team() RETURNS TABLE(user_id uuid, role text, email text, full_name text)
    LANGUAGE plpgsql SECURITY DEFINER
...
CREATE FUNCTION public.get_my_companies() RETURNS TABLE(company_id uuid, company_name text, role text)
    LANGUAGE plpgsql SECURITY DEFINER
    SET search_path TO 'public'
    AS $$
BEGIN
...
CREATE FUNCTION public.get_my_company_id(p_company_id uuid DEFAULT NULL::uuid) RETURNS uuid
    LANGUAGE plpgsql SECURITY DEFINER
    SET search_path TO 'public'
    AS $$
BEGIN
...
CREATE FUNCTION public.get_my_company_metadata() RETURNS TABLE(id uuid, name text, logo_url text, website text, phone text, email text)
    LANGUAGE plpgsql SECURITY DEFINER
    SET search_path TO 'public'
    AS $$
DECLARE
...
CREATE FUNCTION public.get_my_role(p_company_id uuid DEFAULT NULL::uuid) RETURNS text
    LANGUAGE plpgsql SECURITY DEFINER
    AS $$
DECLARE
    v_result TEXT;
...
CREATE FUNCTION public.get_public_invite_info(invite_id uuid) RETURNS jsonb
    LANGUAGE plpgsql SECURITY DEFINER
    AS $$
DECLARE
    result JSONB;
...
CREATE FUNCTION public.get_recent_activity(p_company_id uuid DEFAULT NULL::uuid, p_limit integer DEFAULT 10) RETURNS TABLE(id uuid, action text, details jsonb, created_at timestamp with time zone, user_email text)
    LANGUAGE plpgsql SECURITY DEFINER
    AS $$
BEGIN
    RETURN QUERY
...
CREATE FUNCTION public.get_related_patterns(p_company_id uuid, p_symptoms text[], p_equipment_model text DEFAULT NULL::text) RETURNS TABLE(pattern_id uuid, pattern_type text, pattern_data jsonb, confidence_score integer, occurrence_count integer, relevance_score numeric)
    LANGUAGE plpgsql SECURITY DEFINER
    AS $$
BEGIN
    RETURN QUERY
...
CREATE FUNCTION public.get_user_companies_v2() RETURNS TABLE(company_id uuid, company_name text, role text, is_owner boolean)
    LANGUAGE plpgsql SECURITY DEFINER
    SET search_path TO 'public'
    AS $$
BEGIN
...
CREATE FUNCTION public.get_user_consents(p_user_id uuid) RETURNS TABLE(consent_type text, consent_version text, granted boolean, granted_at timestamp with time zone)
...
CREATE FUNCTION public.get_user_skool_subscriptions() RETURNS TABLE(id uuid, skool_community_id text, skool_community_name text, subscription_status text, subscription_tier text, expires_at timestamp with time zone)
    LANGUAGE plpgsql SECURITY DEFINER
    AS $$
BEGIN
    RETURN QUERY
...
CREATE FUNCTION public.grant_client_access(target_email text, target_client_id uuid) RETURNS jsonb
    LANGUAGE plpgsql SECURITY DEFINER
    SET search_path TO 'public', 'auth'
    AS $$
DECLARE
...
CREATE FUNCTION public.has_consent(p_user_id uuid, p_consent_type text, p_consent_version text DEFAULT 'latest'::text) RETURNS boolean
    LANGUAGE plpgsql SECURITY DEFINER
    SET search_path TO 'public'
    AS $$
DECLARE
...
CREATE FUNCTION public.link_skool_subscription(p_skool_community_id text, p_skool_community_name text DEFAULT NULL::text, p_subscription_tier text DEFAULT NULL::text) RETURNS jsonb
    LANGUAGE plpgsql SECURITY DEFINER
    AS $$
DECLARE
    v_result JSONB;
...
CREATE FUNCTION public.log_audit_event(p_action text, p_company_id uuid, p_user_id uuid DEFAULT NULL::uuid, p_entity_type text DEFAULT NULL::text, p_entity_id uuid DEFAULT NULL::uuid, p_details jsonb DEFAULT '{}'::jsonb) RETURNS uuid
    LANGUAGE plpgsql SECURITY DEFINER
    AS $$
DECLARE
    v_log_id UUID;
...
CREATE FUNCTION public.log_invite_created() RETURNS trigger
    LANGUAGE plpgsql
    AS $$
BEGIN
    PERFORM public.log_audit_event(
...
CREATE FUNCTION public.process_integration_invite() RETURNS trigger
    LANGUAGE plpgsql SECURITY DEFINER
    AS $$
DECLARE
    target_user_id UUID;
...
CREATE FUNCTION public.process_job_scheduling() RETURNS trigger
    LANGUAGE plpgsql SECURITY DEFINER
    AS $$
DECLARE
    client_email TEXT;
...
CREATE FUNCTION public.process_telemetry() RETURNS trigger
    LANGUAGE plpgsql SECURITY DEFINER
    AS $$
DECLARE
    rule RECORD;
...
CREATE FUNCTION public.record_consent(p_user_id uuid, p_consent_type text, p_consent_version text, p_granted boolean, p_ip_address inet DEFAULT NULL::inet, p_user_agent text DEFAULT NULL::text) RETURNS uuid
    LANGUAGE plpgsql SECURITY DEFINER
    SET search_path TO 'public'
    AS $$
DECLARE
...
CREATE FUNCTION public.setup_email_automation_webhook(service_key text, endpoint_url text) RETURNS jsonb
    LANGUAGE plpgsql SECURITY DEFINER
    AS $_$
DECLARE
...
CREATE FUNCTION public.switch_company(target_company_id uuid) RETURNS void
    LANGUAGE plpgsql SECURITY DEFINER
    SET search_path TO 'public'
    AS $$
DECLARE
...
CREATE FUNCTION public.switch_company_context(p_company_id uuid, p_role_override text DEFAULT NULL::text) RETURNS jsonb
    LANGUAGE plpgsql SECURITY DEFINER
    AS $$
DECLARE
    v_company_id UUID;
...
CREATE FUNCTION public.sync_calculation_type() RETURNS trigger
    LANGUAGE plpgsql
    AS $$
BEGIN
...
CREATE FUNCTION public.trigger_review_hunter() RETURNS trigger
    LANGUAGE plpgsql SECURITY DEFINER
    AS $$
DECLARE
    client_phone TEXT;
...
CREATE FUNCTION public.update_company_seat_usage() RETURNS trigger
    LANGUAGE plpgsql
    AS $$
DECLARE
    v_company_id UUID;
...
CREATE FUNCTION public.update_company_settings(p_company_id uuid, p_settings jsonb DEFAULT '{}'::jsonb) RETURNS jsonb
    LANGUAGE plpgsql SECURITY DEFINER
    AS $$
DECLARE
    v_settings JSONB;
...
CREATE FUNCTION public.update_company_settings_timestamp() RETURNS trigger
    LANGUAGE plpgsql
    AS $$
BEGIN
    NEW.updated_at = NOW();
...
CREATE FUNCTION public.update_cylinder_weight() RETURNS trigger
    LANGUAGE plpgsql SECURITY DEFINER
    AS $$
begin
...
CREATE FUNCTION public.update_invitation_links_timestamp() RETURNS trigger
    LANGUAGE plpgsql
    AS $$
BEGIN
    NEW.updated_at = NOW();
...
CREATE FUNCTION public.update_pattern_occurrence(p_pattern_type text, p_pattern_data jsonb, p_company_id uuid, p_equipment_model text DEFAULT NULL::text) RETURNS uuid
    LANGUAGE plpgsql SECURITY DEFINER
    AS $$
DECLARE
    pattern_id uuid;
...
CREATE FUNCTION public.update_seat_limit_from_tier() RETURNS trigger
    LANGUAGE plpgsql
    AS $$
BEGIN
...
CREATE FUNCTION public.update_subscription_plan() RETURNS trigger
    LANGUAGE plpgsql
    AS $$
BEGIN
...
CREATE FUNCTION public.update_user_roles_timestamp() RETURNS trigger
    LANGUAGE plpgsql
    AS $$
BEGIN
    NEW.updated_at = NOW();
...
CREATE FUNCTION public.use_invitation_link(p_slug text) RETURNS jsonb
    LANGUAGE plpgsql SECURITY DEFINER
    AS $$
DECLARE
    v_validation JSONB;
...
CREATE FUNCTION public.validate_invitation_link(p_slug text) RETURNS jsonb
    LANGUAGE plpgsql SECURITY DEFINER
    AS $$
DECLARE
    v_invite JSONB;
...
CREATE FUNCTION public.verify_skool_subscription(p_skool_community_id text DEFAULT NULL::text) RETURNS boolean
    LANGUAGE plpgsql SECURITY DEFINER
    SET search_path TO 'public'
    AS $$
DECLARE
...
CREATE TABLE public.iaq_audits (
    id uuid DEFAULT gen_random_uuid() NOT NULL,
    company_id uuid,
    client_id uuid,
    job_id uuid,
...
CREATE TABLE public.rules_alerts (
    id uuid DEFAULT gen_random_uuid() NOT NULL,
    rule_id uuid,
    asset_id uuid NOT NULL,
    reading_id uuid,
...
CREATE TABLE public.skool_subscriptions (
    id uuid DEFAULT gen_random_uuid() NOT NULL,
    user_id uuid NOT NULL,
...
CREATE POLICY "Authenticated users can upload company logos" ON storage.objects FOR INSERT TO authenticated WITH CHECK (((bucket_id = 'company-assets'::text) AND ((auth.uid())::text = (storage.foldername(name))[1])));
...
CREATE POLICY "Authenticated users can upload evidence" ON storage.objects FOR INSERT WITH CHECK (((bucket_id = 'calculation-evidence'::text) AND (auth.role() = 'authenticated'::text)));
...
CREATE POLICY "Authenticated users can view evidence" ON storage.objects FOR SELECT USING (((bucket_id = 'calculation-evidence'::text) AND (auth.role() = 'authenticated'::text)));
...
CREATE POLICY "IAQ Media Storage" ON storage.objects TO authenticated USING ((bucket_id = 'iaq-reports'::text));
...
CREATE POLICY "Public Access to company assets" ON storage.objects FOR SELECT USING ((bucket_id = 'company-assets'::text));
...
CREATE POLICY "Public Read Triage" ON storage.objects FOR SELECT TO authenticated, anon USING ((bucket_id = 'triage-uploads'::text));
...
CREATE POLICY "Public Uploads Triage" ON storage.objects FOR INSERT TO authenticated, anon WITH CHECK ((bucket_id = 'triage-uploads'::text));
...
\unrestrict MNnU8oxy3ugJD6h157exHhJhtcIf2wlwbtDTfCAkQteia4zfXp059x90BPWMnTm
