--
-- Baseline migration created from 0001_initial_schema.sql
-- Supersedes the following migrations:
--   - 0001_initial_schema_noauth.sql
--   - 0001_initial_schema_original.sql
--   - 0001_initial_schema_processed.sql
--   - 0001_initial_schema_public_only.sql
--   - 0001_initial_schema.raw.sql
--   - 20251130_create_subscriptions.sql
--   - 20251209_create_plans_and_calculations.sql
--   - 20251226000000_blue_ocean_init.sql
--   - 20251226100000_add_evidence_bucket.sql
--   - 20251226110000_add_skill_logs.sql
--   - 20260111150000_create_commercial_tables.sql
--   - 20260111170000_create_workflow_queue.sql
--   - 20260112040534_fix_workflow_rls.sql
--   - 20260115091500_add_alert_settings.sql
--   - 20260115123000_create_client_portal_tables.sql
--   - 20260116140000_enable_automation_logic.sql
--   - 20260117090000_create_user_roles.sql
--   - 20260117100000_grant_access_rpc.sql
--   - 20260117115500_create_jobs_system.sql
--   - 20260117120000_auto_job_trigger.sql
--   - 20260117130000_fix_telemetry.sql
--   - 20260117133000_fix_job_trigger_name.sql
--   - 20260117143000_fix_jobs_schema.sql
--   - 20260118000000_fix_companies_rls.sql
--   - 20260118000001_debug_disable_rls.sql
--   - 20260118000002_reenable_rls.sql
--   - 20260118190000_add_calculations_index.sql
--   - 20260119100000_enable_realtime.sql
--   - 20260119120000_trigger_n8n_queue.sql
--   - 20260119130000_create_integrations.sql
--   - 20260119150000_invite_trigger.sql
--   - 20260120120000_fix_invite_trigger.sql
--   - 20260120124200_update_invite_trigger_replyto.sql
--   - 20260123100000_public_invite_guard.sql
--   - 20260124000500_fix_invite_trigger_auth.sql
--   - 20260125000000_create_epa_tables.sql
--   - 20260126000000_enable_review_hunter.sql
--   - 20260126000001_create_triage_system.sql
--   - 20260128000000_update_user_roles_v2.sql
--   - 20260128000001_update_constraint.sql
--   - 20260128160000_enable_realtime_jobs.sql
--   - 20260129160000_tech_permissions.sql
--   - 20260129162000_fix_timeline_rls.sql
--   - 20260129170000_add_asset_details.sql
--   - 20260130000000_add_asset_epa_fields.sql
--   - 20260130000001_link_logs_to_assets.sql
--   - 20260130000002_add_triage_archived_status.sql
--   - 20260130000003_create_iaq_system.sql
--   - 20260130000004_fix_mobile_rls.sql
--   - 20260130000005_add_n8n_config.sql
--   - 20260130000006_update_telemetry_trigger.sql
--   - 20260130000007_add_manager_enum.sql
--   - 20260130000008_add_fintech_fields.sql
--   - 20260130000009_manager_policies.sql
--   - 20260131000000_fix_manager_recursion_manual.sql
--   - 20260131000001_fix_manager_admin_policies.sql
--   - 20260131000002_fix_admin_role_detection.sql
--   - 20260131000003_fix_manager_admin_crud.sql
--   - 20260131000004_force_admin_role.sql
--   - 20260131140000_fix_tech_visibility.sql
--   - 20260131180000_enable_jobs_rls.sql
--   - 20260131183000_debug_jobs_rls.sql
--   - 20260131184000_disable_jobs_rls.sql
--   - 20260131190000_final_jobs_rls.sql
--   - 20260201000000_add_client_notification_prefs.sql
--   - 20260201000001_reset_companies_rls.sql
--   - 20260201120000_add_invoice_items.sql
--   - 20260201120100_fix_user_roles_rls.sql
--   - 20260201124500_add_email_to_review_trigger.sql
--   - 20260201130000_asset_audit_logs.sql
--   - 20260201140000_trigger_job_email.sql
--   - 20260201150000_enable_webhook_rpc.sql
--   - 20260201151500_fix_webhook_rpc.sql
--   - 20260201160000_create_invoices.sql
--   - 20260201202000_create_warranty_claims.sql
--   - 20260201210000_fix_review_hunter_trigger.sql
--   - 20260202000000_consolidate_rbac.sql
--   - 20260202000002_get_company_team.sql
--   - 20260202000003_consolidate_clients_and_fix_jobs.sql
--   - 20260202000004_fix_get_team_rpc.sql
--   - 20260202000005_fix_get_team_rpc_types.sql
--   - 20260202000006_update_manager_constraint.sql
--   - 20260202100000_update_process_telemetry.sql
--   - 20260203000000_harden_automation_rls.sql
--   - 20260203000001_optimize_company_metadata.sql
--   - 20260203000002_add_seat_limit.sql
--   - 20260203000004_fix_get_my_role.sql
--   - 20260203000005_fix_team_auth_fallback.sql
--   - 20260204000000_force_fix_rpc.sql
--   - 20260204000003_debug_rpc.sql
--   - 20260204000004_debug_rpc_v2.sql
--   - 20260204000005_fix_rpc_final.sql
--   - 20260204000006_debug_rpc_v3.sql
--   - 20260204000007_restore_real_rpc.sql
--   - 20260204000009_fix_ambiguous_email.sql
--   - 20260204000010_company_switcher.sql
--   - 20260204000012_fix_switcher_ownership.sql
--   - 20260204000099_debug_rpc.sql
--   - 20260204000101_fix_companies_rpc_syntax.sql
--   - 20260204000102_secure_active_company_policies.sql
--   - 20260204013946_add_weather_intelligence_fields.sql
--   - 20260204124429_drop_n8n_config.sql
--   - 20260205000000_create_ai_learning_patterns.sql
--   - 20260205000001_fix_get_my_companies_rpc.sql
--   - 20260205000002_fix_jobs_rls_policy.sql
--   - 20260205000003_fix_get_my_companies.sql
--   - 20260205200000_multi_company_core.sql
--   - 20260205210000_skool_integration.sql
--   - 20260206000001_invite_codes_rls.sql
--   - 20260206000002_seat_limits.sql
--   - 20260206000003_audit_logs.sql
--   - 20260206000004_company_settings.sql
--   - 20260206000005_fix_rpc_bugs.sql
--   - 20260206000006_robust_rpc_fix.sql
--   - 20260206000007_fix_seat_limit_json.sql
--   - 20260206000008_drop_ambiguous_rpc.sql
--   - 20260206002534_fix_rpc_param.sql
--   - 20260206230000_update_plans_and_subscriptions.sql
--   - 20260206234000_create_usage_tracking.sql
--   - 20260207000000_fix_ambiguous_functions.sql
--   - 20260207010000_seed_test_invite.sql
--   - 20260207020000_fix_company_fetching.sql
--   - 20260207030000_enforce_seat_limits.sql
--   - 20260207030500_skool_gate.sql
--   - 20260207040000_drop_companies_user_id_unique.sql
--   - 20260207150000_fix_validate_invite_code.sql
--   - 20260207160000_fix_skool_verification.sql
--   - 20260207170000_fix_ambiguous_role.sql
--   - 20260207180000_fix_role_ambiguity_complete.sql
--   - 20260207200000_redesign_onboarding.sql
--   - 20260207210000_remove_skool_verification.sql
--   - 20260207220000_add_calculation_type_column.sql
--   - 20260208000000_create_user_consents.sql
...
CREATE OR REPLACE FUNCTION public.get_my_company_id(p_company_id uuid) RETURNS uuid
    LANGUAGE plpgsql SECURITY DEFINER
    SET search_path TO 'public'
    AS $$
BEGIN
...
CREATE OR REPLACE FUNCTION public.get_my_role(p_company_id uuid) RETURNS text
    LANGUAGE plpgsql SECURITY DEFINER
    AS $$
DECLARE
    v_result TEXT;
...
DO $$ BEGIN
  IF NOT EXISTS (SELECT 1 FROM pg_constraint WHERE conname = 'ai_learning_patterns_pkey') THEN
    ALTER TABLE ONLY public.ai_learning_patterns ADD CONSTRAINT ai_learning_patterns_pkey PRIMARY KEY (id);;
  END IF;
END $$;
...
DO $$ BEGIN
  IF NOT EXISTS (SELECT 1 FROM pg_constraint WHERE conname = 'asset_audit_logs_pkey') THEN
    ALTER TABLE ONLY public.asset_audit_logs ADD CONSTRAINT asset_audit_logs_pkey PRIMARY KEY (id);;
  END IF;
END $$;
...
DO $$ BEGIN
  IF NOT EXISTS (SELECT 1 FROM pg_constraint WHERE conname = 'asset_mappings_pkey') THEN
    ALTER TABLE ONLY public.asset_mappings ADD CONSTRAINT asset_mappings_pkey PRIMARY KEY (id);;
  END IF;
END $$;
...
DO $$ BEGIN
  IF NOT EXISTS (SELECT 1 FROM pg_constraint WHERE conname = 'calculations_pkey') THEN
...
DO $$ BEGIN
  IF NOT EXISTS (SELECT 1 FROM pg_constraint WHERE conname = 'diagnostic_outcomes_pkey') THEN
    ALTER TABLE ONLY public.diagnostic_outcomes ADD CONSTRAINT diagnostic_outcomes_pkey PRIMARY KEY (id);;
  END IF;
END $$;
...
DO $$ BEGIN
  IF NOT EXISTS (SELECT 1 FROM pg_constraint WHERE conname = 'iaq_audits_pkey') THEN
    ALTER TABLE ONLY public.iaq_audits ADD CONSTRAINT iaq_audits_pkey PRIMARY KEY (id);;
  END IF;
END $$;
...
DO $$ BEGIN
  IF NOT EXISTS (SELECT 1 FROM pg_constraint WHERE conname = 'integrations_pkey') THEN
...
DO $$ BEGIN
  IF NOT EXISTS (SELECT 1 FROM pg_constraint WHERE conname = 'invitation_links_pkey') THEN
    ALTER TABLE ONLY public.invitation_links ADD CONSTRAINT invitation_links_pkey PRIMARY KEY (id);;
  END IF;
END $$;
...
DO $$ BEGIN
  IF NOT EXISTS (SELECT 1 FROM pg_constraint WHERE conname = 'job_timeline_pkey') THEN
    ALTER TABLE ONLY public.job_timeline ADD CONSTRAINT job_timeline_pkey PRIMARY KEY (id);;
  END IF;
END $$;
...
DO $$ BEGIN
  IF NOT EXISTS (SELECT 1 FROM pg_constraint WHERE conname = 'licenses_pkey') THEN
    ALTER TABLE ONLY public.licenses ADD CONSTRAINT licenses_pkey PRIMARY KEY (key);;
  END IF;
END $$;
...
DO $$ BEGIN
  IF NOT EXISTS (SELECT 1 FROM pg_constraint WHERE conname = 'refrigerant_cylinders_pkey') THEN
    ALTER TABLE ONLY public.refrigerant_cylinders ADD CONSTRAINT refrigerant_cylinders_pkey PRIMARY KEY (id);;
  END IF;
END $$;
...
DO $$ BEGIN
  IF NOT EXISTS (SELECT 1 FROM pg_constraint WHERE conname = 'refrigerant_logs_pkey') THEN
    ALTER TABLE ONLY public.refrigerant_logs ADD CONSTRAINT refrigerant_logs_pkey PRIMARY KEY (id);;
  END IF;
END $$;
...
DO $$ BEGIN
  IF NOT EXISTS (SELECT 1 FROM pg_constraint WHERE conname = 'rules_alerts_pkey') THEN
    ALTER TABLE ONLY public.rules_alerts ADD CONSTRAINT rules_alerts_pkey PRIMARY KEY (id);;
  END IF;
END $$;
...
DO $$ BEGIN
  IF NOT EXISTS (SELECT 1 FROM pg_constraint WHERE conname = 'skill_logs_pkey') THEN
    ALTER TABLE ONLY public.skill_logs ADD CONSTRAINT skill_logs_pkey PRIMARY KEY (id);;
  END IF;
END $$;
...
DO $$ BEGIN
  IF NOT EXISTS (SELECT 1 FROM pg_constraint WHERE conname = 'skool_subscriptions_pkey') THEN
    ALTER TABLE ONLY public.skool_subscriptions ADD CONSTRAINT skool_subscriptions_pkey PRIMARY KEY (id);;
  END IF;
END $$;
...
DO $$ BEGIN
  IF NOT EXISTS (SELECT 1 FROM pg_constraint WHERE conname = 'telemetry_readings_pkey') THEN
...
DO $$ BEGIN
  IF NOT EXISTS (SELECT 1 FROM pg_constraint WHERE conname = 'triage_submissions_pkey') THEN
    ALTER TABLE ONLY public.triage_submissions ADD CONSTRAINT triage_submissions_pkey PRIMARY KEY (id);;
  END IF;
END $$;
...
DO $$ BEGIN
  IF NOT EXISTS (SELECT 1 FROM pg_constraint WHERE conname = 'user_consents_pkey') THEN
...
DO $$ BEGIN
  IF NOT EXISTS (SELECT 1 FROM pg_constraint WHERE conname = 'user_roles_pkey') THEN
    ALTER TABLE ONLY public.user_roles ADD CONSTRAINT user_roles_pkey PRIMARY KEY (user_id, company_id);;
  END IF;
END $$;
...
DO $$ BEGIN
  IF NOT EXISTS (SELECT 1 FROM pg_constraint WHERE conname = 'warranty_claims_pkey') THEN
    ALTER TABLE ONLY public.warranty_claims ADD CONSTRAINT warranty_claims_pkey PRIMARY KEY (id);;
  END IF;
END $$;
...
DO $$ BEGIN
  IF NOT EXISTS (SELECT 1 FROM pg_constraint WHERE conname = 'workflow_requests_pkey') THEN
    ALTER TABLE ONLY public.workflow_requests ADD CONSTRAINT workflow_requests_pkey PRIMARY KEY (id);;
  END IF;
END $$;
...
CREATE INDEX IF NOT EXISTS idx_ai_learning_patterns_company ON public.ai_learning_patterns USING btree (company_id);
...
CREATE INDEX IF NOT EXISTS idx_ai_learning_patterns_last_seen ON public.ai_learning_patterns USING btree (last_seen);
...
CREATE INDEX IF NOT EXISTS idx_ai_learning_patterns_model ON public.ai_learning_patterns USING btree (equipment_model);
...
CREATE INDEX IF NOT EXISTS idx_ai_learning_patterns_type ON public.ai_learning_patterns USING btree (pattern_type);
...
CREATE INDEX IF NOT EXISTS idx_calculations_created ON public.calculations USING btree (created_at DESC);
...
CREATE INDEX IF NOT EXISTS idx_calculations_user_created ON public.calculations USING btree (user_id, created_at DESC);
...
CREATE INDEX IF NOT EXISTS idx_clients_notification_prefs ON public.clients USING gin (notification_preferences);
...
CREATE INDEX IF NOT EXISTS idx_diagnostic_outcomes_company ON public.diagnostic_outcomes USING btree (company_id);
...
CREATE INDEX IF NOT EXISTS idx_diagnostic_outcomes_session ON public.diagnostic_outcomes USING btree (troubleshooting_session_id);
...
CREATE INDEX IF NOT EXISTS idx_diagnostic_outcomes_success ON public.diagnostic_outcomes USING btree (success_rating);
...
CREATE INDEX IF NOT EXISTS idx_invitation_links_company ON public.invitation_links USING btree (company_id);
...
CREATE INDEX IF NOT EXISTS idx_invitation_links_slug ON public.invitation_links USING btree (slug);
...
CREATE INDEX IF NOT EXISTS idx_skool_subs_community ON public.skool_subscriptions USING btree (skool_community_id);
...
CREATE INDEX IF NOT EXISTS idx_skool_subs_user ON public.skool_subscriptions USING btree (user_id);
...
CREATE INDEX IF NOT EXISTS subscriptions_plan_idx ON public.subscriptions USING btree (plan);
...
CREATE POLICY "Admins can manage settings" ON public.company_settings TO authenticated USING (((company_id IN ( SELECT companies.id
   FROM public.companies
...
CREATE POLICY "Admins can update roles for their company" ON public.user_roles FOR UPDATE USING ((EXISTS ( SELECT 1
...
CREATE POLICY "Admins can view all jobs" ON public.jobs FOR SELECT TO authenticated USING ((EXISTS ( SELECT 1
   FROM public.user_roles
...
CREATE POLICY "Admins can view audit logs" ON public.audit_logs FOR SELECT TO authenticated USING (((company_id IN ( SELECT companies.id
   FROM public.companies
  WHERE (companies.user_id = auth.uid()))) OR (EXISTS ( SELECT 1
   FROM public.user_roles
...
CREATE POLICY "Admins can view triage" ON public.triage_submissions FOR SELECT USING ((auth.role() = 'authenticated'::text));
...
CREATE POLICY "Allow public submissions" ON public.triage_submissions FOR INSERT TO authenticated, anon WITH CHECK (true);
...
CREATE POLICY "Clients can view their own invoices" ON public.invoices FOR SELECT USING ((client_id IN ( SELECT user_roles.client_id
   FROM public.user_roles
...
CREATE POLICY "Clients view their own invoices" ON public.invoices FOR SELECT USING ((client_id IN ( SELECT user_roles.client_id
   FROM public.user_roles
  WHERE (user_roles.user_id = auth.uid()))));
...
CREATE POLICY "Company Admins can manage invoices" ON public.invoices USING ((company_id IN ( SELECT companies.id
   FROM public.companies
...
CREATE POLICY "Company Admins manage invoices" ON public.invoices USING ((company_id IN ( SELECT companies.id
   FROM public.companies
  WHERE (companies.user_id = auth.uid()))));
...
CREATE POLICY "Company can insert own outcomes" ON public.diagnostic_outcomes FOR INSERT WITH CHECK ((company_id IN ( SELECT companies.id
   FROM public.companies
  WHERE (companies.user_id = auth.uid()))));
...
CREATE POLICY "Company can insert own patterns" ON public.ai_learning_patterns FOR INSERT WITH CHECK ((company_id IN ( SELECT companies.id
   FROM public.companies
  WHERE (companies.user_id = auth.uid()))));
...
CREATE POLICY "Company can update own outcomes" ON public.diagnostic_outcomes FOR UPDATE USING ((company_id IN ( SELECT companies.id
   FROM public.companies
  WHERE (companies.user_id = auth.uid()))));
...
CREATE POLICY "Company can update own patterns" ON public.ai_learning_patterns FOR UPDATE USING ((company_id IN ( SELECT companies.id
   FROM public.companies
  WHERE (companies.user_id = auth.uid()))));
...
CREATE POLICY "Company can view own outcomes" ON public.diagnostic_outcomes FOR SELECT USING ((company_id IN ( SELECT companies.id
   FROM public.companies
  WHERE (companies.user_id = auth.uid()))));
...
CREATE POLICY "Company can view own patterns" ON public.ai_learning_patterns FOR SELECT USING ((company_id IN ( SELECT companies.id
   FROM public.companies
  WHERE (companies.user_id = auth.uid()))));
...
CREATE POLICY "Enable asset read for all authenticated users" ON public.assets FOR SELECT TO authenticated USING (true);
...
CREATE POLICY "Manage IAQ Audits" ON public.iaq_audits USING ((company_id IN ( SELECT companies.id
   FROM public.companies
  WHERE (companies.user_id = auth.uid()))));
...
CREATE POLICY "Manage: Admin ONLY create/delete roles" ON public.user_roles USING (((public.get_my_role() = 'admin'::public.user_role) AND (company_id = public.get_my_company_id())));
...
CREATE POLICY "Manage: Admin/Manager update company roles" ON public.user_roles FOR UPDATE USING (((public.get_my_role() = ANY (ARRAY['admin'::public.user_role, 'manager'::public.user_role])) AND (company_id = public.get_my_company_id())));
...
CREATE POLICY "Manage: Admin/Manager view company roles" ON public.user_roles FOR SELECT USING ((((public.get_my_role() = ANY (ARRAY['admin'::public.user_role, 'manager'::public.user_role])) AND (company_id = public.get_my_company_id())) OR (user_id = auth.uid())));
...
CREATE POLICY "Managers can create company assets" ON public.assets FOR INSERT WITH CHECK (((client_id IN ( SELECT clients.id
   FROM public.clients
...
CREATE POLICY "Managers can create company jobs" ON public.jobs FOR INSERT WITH CHECK (((client_id IN ( SELECT clients.id
   FROM public.clients
  WHERE (clients.company_id = public.get_my_company_id()))) AND (public.get_my_role() = ANY (ARRAY['admin'::public.user_role, 'manager'::public.user_role]))));
...
CREATE POLICY "Managers can delete company assets" ON public.assets FOR DELETE USING (((client_id IN ( SELECT clients.id
   FROM public.clients
  WHERE (clients.company_id = public.get_my_company_id()))) AND (public.get_my_role() = ANY (ARRAY['admin'::public.user_role, 'manager'::public.user_role]))));
...
CREATE POLICY "Managers can delete company jobs" ON public.jobs FOR DELETE USING (((client_id IN ( SELECT clients.id
   FROM public.clients
  WHERE (clients.company_id = public.get_my_company_id()))) AND (public.get_my_role() = ANY (ARRAY['admin'::public.user_role, 'manager'::public.user_role]))));
...
CREATE POLICY "Managers can update company assets" ON public.assets FOR UPDATE USING (((client_id IN ( SELECT clients.id
   FROM public.clients
  WHERE (clients.company_id = public.get_my_company_id()))) AND (public.get_my_role() = ANY (ARRAY['admin'::public.user_role, 'manager'::public.user_role]))));
...
CREATE POLICY "Managers can update company jobs" ON public.jobs FOR UPDATE USING (((client_id IN ( SELECT clients.id
   FROM public.clients
  WHERE (clients.company_id = public.get_my_company_id()))) AND (public.get_my_role() = ANY (ARRAY['admin'::public.user_role, 'manager'::public.user_role]))));
...
CREATE POLICY "Managers can update company user roles" ON public.user_roles FOR UPDATE USING (((company_id = public.get_my_company_id()) AND (public.get_my_role() = ANY (ARRAY['admin'::public.user_role, 'manager'::public.user_role]))));
...
CREATE POLICY "RBAC: Create Jobs" ON public.jobs FOR INSERT WITH CHECK (((public.get_my_role() = ANY (ARRAY['admin'::public.user_role, 'manager'::public.user_role])) AND ((company_id = public.get_my_company_id()) OR (client_id IN ( SELECT clients.id
   FROM public.clients
...
CREATE POLICY "RBAC: Create Requests" ON public.workflow_requests FOR INSERT WITH CHECK ((auth.uid() = user_id));
...
CREATE POLICY "RBAC: Delete Jobs" ON public.jobs FOR DELETE USING (((public.get_my_role() = 'admin'::public.user_role) AND ((company_id = public.get_my_company_id()) OR (client_id IN ( SELECT clients.id
   FROM public.clients
  WHERE (clients.company_id = public.get_my_company_id()))))));
...
CREATE POLICY "RBAC: Manage Assets" ON public.assets USING (((public.get_my_role() = ANY (ARRAY['admin'::public.user_role, 'manager'::public.user_role])) AND (client_id IN ( SELECT clients.id
   FROM public.clients
  WHERE (clients.company_id = public.get_my_company_id())))));
...
CREATE POLICY "RBAC: Manage Clients" ON public.clients USING (((public.get_my_role() = ANY (ARRAY['admin'::public.user_role, 'manager'::public.user_role])) AND (company_id = public.get_my_company_id()))) WITH CHECK (((public.get_my_role() = ANY (ARRAY['admin'::public.user_role, 'manager'::public.user_role])) AND (company_id = public.get_my_company_id())));
...
CREATE POLICY "RBAC: Manage Invitation Links" ON public.invitation_links TO authenticated USING (((company_id IN ( SELECT companies.id
   FROM public.companies
  WHERE (companies.user_id = auth.uid()))) OR (EXISTS ( SELECT 1
   FROM public.user_roles
...
CREATE POLICY "RBAC: Manage Rules" ON public.automation_rules USING (((public.get_my_role() = ANY (ARRAY['admin'::public.user_role, 'manager'::public.user_role])) AND (company_id = public.get_my_company_id())));
...
CREATE POLICY "RBAC: Manager Retry" ON public.workflow_requests FOR UPDATE USING (((public.get_my_role() = ANY (ARRAY['admin'::public.user_role, 'manager'::public.user_role])) AND (user_id IN ( SELECT user_roles.user_id
   FROM public.user_roles
...
CREATE POLICY "RBAC: Update Jobs" ON public.jobs FOR UPDATE USING ((((public.get_my_role() = ANY (ARRAY['admin'::public.user_role, 'manager'::public.user_role])) AND ((company_id = public.get_my_company_id()) OR (client_id IN ( SELECT clients.id
   FROM public.clients
...
CREATE POLICY "RBAC: View Asset Audit Logs" ON public.asset_audit_logs FOR SELECT USING ((public.get_my_role() = ANY (ARRAY['admin'::public.user_role, 'manager'::public.user_role])));
...
CREATE POLICY "RBAC: View Assets" ON public.assets FOR SELECT USING ((((public.get_my_role() = ANY (ARRAY['admin'::public.user_role, 'manager'::public.user_role, 'tech'::public.user_role])) AND (client_id IN ( SELECT clients.id
   FROM public.clients
...
CREATE POLICY "RBAC: View Clients" ON public.clients FOR SELECT USING ((((public.get_my_role() = ANY (ARRAY['admin'::public.user_role, 'manager'::public.user_role, 'tech'::public.user_role])) AND (company_id = public.get_my_company_id())) OR ((public.get_my_role() = 'client'::public.user_role) AND (id IN ( SELECT user_roles.client_id
   FROM public.user_roles
  WHERE (user_roles.user_id = auth.uid()))))));
...
CREATE POLICY "RBAC: View Jobs" ON public.jobs FOR SELECT USING ((((public.get_my_role() = ANY (ARRAY['admin'::public.user_role, 'manager'::public.user_role])) AND ((company_id = public.get_my_company_id()) OR (client_id IN ( SELECT clients.id
   FROM public.clients
...
CREATE POLICY "RBAC: View Jobs Multi-Company" ON public.jobs FOR SELECT USING (((EXISTS ( SELECT 1
...
CREATE POLICY "RBAC: View Requests" ON public.workflow_requests FOR SELECT USING (((auth.uid() = user_id) OR ((public.get_my_role() = ANY (ARRAY['admin'::public.user_role, 'manager'::public.user_role])) AND (user_id IN ( SELECT user_roles.user_id
   FROM public.user_roles
  WHERE (user_roles.company_id = public.get_my_company_id()))))));
...
CREATE POLICY "RBAC: View Rules" ON public.automation_rules FOR SELECT USING (((public.get_my_role() = ANY (ARRAY['admin'::public.user_role, 'manager'::public.user_role, 'tech'::public.user_role])) AND (company_id = public.get_my_company_id())));
...
CREATE POLICY "Read access for authenticated users" ON public.job_timeline FOR SELECT TO authenticated USING (true);
...
CREATE POLICY "Service Role can insert telemetry" ON public.telemetry_readings FOR INSERT WITH CHECK (true);
...
CREATE POLICY "Service Role full access outcomes" ON public.diagnostic_outcomes USING ((auth.role() = 'service_role'::text)) WITH CHECK ((auth.role() = 'service_role'::text));
...
CREATE POLICY "Service Role full access patterns" ON public.ai_learning_patterns USING ((auth.role() = 'service_role'::text)) WITH CHECK ((auth.role() = 'service_role'::text));
...
CREATE POLICY "Service role can manage all subscriptions" ON public.subscriptions USING ((auth.role() = 'service_role'::text));
...
CREATE POLICY "Strict Company Isolation" ON public.clients TO authenticated USING ((company_id = public.get_my_company_id())) WITH CHECK ((company_id = public.get_my_company_id()));
...
CREATE POLICY "Strict Company Isolation" ON public.invoices TO authenticated USING ((company_id = public.get_my_company_id())) WITH CHECK ((company_id = public.get_my_company_id()));
...
CREATE POLICY "Strict Company Isolation" ON public.jobs TO authenticated USING ((company_id = public.get_my_company_id())) WITH CHECK ((company_id = public.get_my_company_id()));
...
CREATE POLICY "Technicians can update own jobs" ON public.jobs FOR UPDATE TO authenticated USING ((technician_id = auth.uid())) WITH CHECK ((technician_id = auth.uid()));
...
CREATE POLICY "Techs and Admins can add timeline events" ON public.job_timeline FOR INSERT WITH CHECK ((job_id IN ( SELECT jobs.id
   FROM public.jobs)));
...
CREATE POLICY "Techs can insert timeline for own jobs" ON public.job_timeline FOR INSERT TO authenticated WITH CHECK ((EXISTS ( SELECT 1
   FROM public.jobs
...
CREATE POLICY "Users can delete integrations for their clients" ON public.integrations FOR DELETE USING ((client_id IN ( SELECT clients.id
   FROM public.clients
...
CREATE POLICY "Users can delete their own consents" ON public.user_consents FOR DELETE USING ((auth.uid() = user_id));
...
CREATE POLICY "Users can delete their own warranty claims" ON public.warranty_claims FOR DELETE USING ((auth.uid() = user_id));
...
CREATE POLICY "Users can insert integrations for their clients" ON public.integrations FOR INSERT WITH CHECK ((client_id IN ( SELECT clients.id
   FROM public.clients
  WHERE (clients.company_id IN ( SELECT companies.id
           FROM public.companies
          WHERE (companies.user_id = auth.uid()))))));
...
CREATE POLICY "Users can insert own workflow_requests" ON public.workflow_requests FOR INSERT TO authenticated WITH CHECK ((auth.uid() = user_id));
...
CREATE POLICY "Users can insert their own cylinders" ON public.refrigerant_cylinders FOR INSERT WITH CHECK ((auth.uid() = user_id));
...
CREATE POLICY "Users can insert their own logs" ON public.refrigerant_logs FOR INSERT WITH CHECK ((auth.uid() = user_id));
...
CREATE POLICY "Users can insert their own skill logs" ON public.skill_logs FOR INSERT WITH CHECK ((auth.uid() = user_id));
...
CREATE POLICY "Users can insert their own warranty claims" ON public.warranty_claims FOR INSERT WITH CHECK ((auth.uid() = user_id));
...
CREATE POLICY "Users can manage asset mappings" ON public.asset_mappings USING ((asset_id IN ( SELECT assets.id
   FROM public.assets
...
CREATE POLICY "Users can manage assets of their clients" ON public.assets USING ((client_id IN ( SELECT clients.id
   FROM public.clients
  WHERE (clients.company_id IN ( SELECT companies.id
           FROM public.companies
          WHERE (companies.user_id = auth.uid()))))));
...
CREATE POLICY "Users can update integrations for their clients" ON public.integrations FOR UPDATE USING ((client_id IN ( SELECT clients.id
   FROM public.clients
  WHERE (clients.company_id IN ( SELECT companies.id
           FROM public.companies
          WHERE (companies.user_id = auth.uid()))))));
...
CREATE POLICY "Users can update their alerts" ON public.rules_alerts FOR UPDATE USING ((asset_id IN ( SELECT assets.id
   FROM public.assets
  WHERE (assets.client_id IN ( SELECT clients.id
           FROM public.clients
          WHERE (clients.company_id IN ( SELECT companies.id
...
CREATE POLICY "Users can update their own cylinders" ON public.refrigerant_cylinders FOR UPDATE USING ((auth.uid() = user_id));
...
CREATE POLICY "Users can update their own warranty claims" ON public.warranty_claims FOR UPDATE USING ((auth.uid() = user_id));
...
CREATE POLICY "Users can view alerts" ON public.rules_alerts FOR SELECT USING (((asset_id IN ( SELECT assets.id
   FROM public.assets
  WHERE (assets.client_id IN ( SELECT clients.id
           FROM public.clients
          WHERE (clients.company_id IN ( SELECT companies.id
...
CREATE POLICY "Users can view integrations for their clients" ON public.integrations FOR SELECT USING ((client_id IN ( SELECT clients.id
   FROM public.clients
  WHERE (clients.company_id IN ( SELECT companies.id
           FROM public.companies
          WHERE (companies.user_id = auth.uid()))))));
...
CREATE POLICY "Users can view own workflow_requests" ON public.workflow_requests FOR SELECT TO authenticated USING ((auth.uid() = user_id));
...
CREATE POLICY "Users can view telemetry" ON public.telemetry_readings FOR SELECT USING ((asset_id IN ( SELECT assets.id
   FROM public.assets
  WHERE (assets.client_id IN ( SELECT clients.id
           FROM public.clients
          WHERE (clients.company_id IN ( SELECT companies.id
...
CREATE POLICY "Users can view their alerts" ON public.rules_alerts FOR SELECT USING ((asset_id IN ( SELECT assets.id
   FROM public.assets
  WHERE (assets.client_id IN ( SELECT clients.id
           FROM public.clients
          WHERE (clients.company_id IN ( SELECT companies.id
...
CREATE POLICY "Users can view their own cylinders" ON public.refrigerant_cylinders FOR SELECT USING ((auth.uid() = user_id));
...
CREATE POLICY "Users can view their own logs" ON public.refrigerant_logs FOR SELECT USING ((auth.uid() = user_id));
...
CREATE POLICY "Users can view their own skill logs" ON public.skill_logs FOR SELECT USING ((auth.uid() = user_id));
...
CREATE POLICY "Users can view their own warranty claims" ON public.warranty_claims FOR SELECT USING ((auth.uid() = user_id));
...
CREATE POLICY "Users can view timeline of accessible jobs" ON public.job_timeline FOR SELECT USING ((job_id IN ( SELECT jobs.id
   FROM public.jobs)));
...
CREATE POLICY "View Active Company Details" ON public.companies FOR SELECT TO authenticated USING (((id = public.get_my_company_id()) OR (id IN ( SELECT user_roles.company_id
   FROM public.user_roles
...
CREATE POLICY "View Active Company Invitation Links" ON public.invitation_links FOR SELECT TO authenticated USING (((company_id IN ( SELECT companies.id
   FROM public.companies
  WHERE (companies.user_id = auth.uid()))) OR (EXISTS ( SELECT 1
   FROM public.user_roles
...
CREATE POLICY "View Members of Active Company" ON public.user_roles FOR SELECT TO authenticated USING (((company_id = public.get_my_company_id()) OR (user_id = auth.uid())));
...
CREATE POLICY "View Technicians" ON public.user_roles FOR SELECT TO authenticated USING ((role = ANY (ARRAY['technician'::public.user_role, 'tech'::public.user_role])));
