-- Fix get_company_team for company owners
-- Uses public.get_my_role() and public.get_my_company_id() for fallback detection
...
BEGIN
    ...
    ORDER BY 
        (role = 'admin') DESC, (role = 'manager') DESC, email ASC;
END;
$$;
