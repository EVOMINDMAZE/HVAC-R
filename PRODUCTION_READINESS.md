...
- [ ] **n8n**: `supabase_queue_worker.json` updated. **Action**: Import into n8n and select Twilio Credentials.
...
- [ ] **Console Logs**:
    - [ ] Remove or silence verbose `[Workflow] ...` logs in `client/hooks/useWorkflowTrigger.ts`.
- [ ] **Polling Safety**:
