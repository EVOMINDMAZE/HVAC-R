---
name: ThermoNeural Skills & Documentation
description: Welcome to the consolidated skills and documentation library. This directory is the single source of truth for all project knowledge, from high-lev...
version: 1.0
---

# ThermoNeural Skills & Documentation

This directory organizes the project's skills and domain knowledge into logical categories. Each `.md` file is a "skill"—a piece of documentation with YAML frontmatter describing its purpose, version, and metadata.

For a complete overview of all documentation, see the [Documentation Navigation Map](../docs/documentation-navigation.md).

## 📂 Directory Structure

### [00_Meta](./00_meta/)

Template and metadata management.
...
- [Pricing Model](./02_business/pricing_model.md): Detailed pricing structures and revenue streams.
...
- [Comprehensive Deployment Guide](./03_development/deployment.md): **Complete deployment guide** covering Supabase, Netlify, Render, CI/CD, troubleshooting.
...
AI agents, protocols, and engine configuration.

- [AI Agents & Protocols](./04_ai/agents.md): Standards for AI agents (Antigravity) including protocols, authentication, and testing.
