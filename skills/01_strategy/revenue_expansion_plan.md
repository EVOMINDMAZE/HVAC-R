...
*   **Smart Integration**:
    *   **The "Dongle" Effect**: The App's "Superheat Calculator" *auto-detects* the probe.
...
*   **Concept**: Allow Technicians to offer financing to homeowners *at the kitchen table*.
*   **Smart Integration**:
    *   **The Trigger**: Inside the **Invoice Generator** (existing feature).
    *   **The UI**: A toggle: *"Enable Monthly Payments for Customer?"*
    *   **The Flow**:
        1.  Tech quotes $12,000 for a new system.
        2.  App displays: *"Or $199/mo via Wisetack"*.
...
*   **Smart Integration**:
    *   **The Data**: We already have `n8n` nodes collecting GPS and job status.
