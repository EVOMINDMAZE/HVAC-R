---
name: Render Calculation Service 🧮
description: While the Core App lives on Supabase/Netlify and Automations live on Supabase Edge Functions, the Heavy Math (Complex Psychometrics, Load Calculation...
version: 1.0
---
