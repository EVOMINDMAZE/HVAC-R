...
export function WebStories() {
  ...
  const [selectedStory, setSelectedStory] = useState<SanityWebStory | null>(
    null,
  );
          ...
          <div className="flex flex-col md:flex-row justify-between items-end mb-12 gap-8">
            ...
            >
              ...
              <p className="text-lg text-muted-foreground max-w-xl leading-relaxed">
                Bite-sized visual guides on troubleshooting, refrigerants, and
                industry updates. Tap to watch.
              </p>
            </motion.div>
          </div>
