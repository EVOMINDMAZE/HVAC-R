...
import { calculateSuperheat, calculateSubcooling, calculateTargetSuperheat } from '@/lib/formula-oracle';
...
const AgentSandbox = () => {
    ...
    const [healthStatus, setHealthStatus] = useState<any>({ env: 'Loading...', db: 'Loading...' });
    ...
    return (
        <div className="p-8 space-y-6 max-w-4xl mx-auto">
            <h1 className="text-3xl font-bold mb-8">🤖 AI Agent Performance Sandbox</h1>
                ...
                <Card>
                    ...
                    <CardContent className="space-y-2">
                        <div className="flex justify-between">
                            ...
                            <Badge variant={healthStatus.env === 'Healthy' ? 'default' : 'destructive'}>
                                {healthStatus.env}
                            </Badge>
                        </div>
                        <div className="flex justify-between">
                            <span>DB Connection:</span>
                            <Badge variant={healthStatus.db === 'Connected' ? 'secondary' : 'outline'}>
                                {healthStatus.db}
                            </Badge>
                        </div>
                    </CardContent>
                    ...
                    <CardContent>
                        <div className="grid grid-cols-3 gap-4">
                            <div className="p-4 bg-muted rounded-lg">
                                ...
                                <p className="text-xs text-muted-foreground mt-1">Expected: ~10.45°F</p>
                            </div>
                            <div className="p-4 bg-muted rounded-lg">
                                ...
                                <p className="text-xs text-muted-foreground mt-1">Expected: ~13.00°F</p>
                            </div>
                            <div className="p-4 bg-muted rounded-lg">
            ...
            <div className="mt-8 p-4 bg-blue-50 border border-blue-200 rounded text-blue-800 text-sm">
                💡 <strong>Agent Insight:</strong> This sandbox allows any future agent to verify that the app's "Core Logic" is
                healthy in less than 500ms of page load.
            </div>
        </div>
    );
};
