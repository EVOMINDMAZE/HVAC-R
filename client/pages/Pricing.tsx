      ...
      <div className="max-w-7xl mx-auto px-4 py-16">
          ...
          {plans.map((plan) => (
            <Card 
              ...
              className={`relative bg-white shadow-xl border-2 ${
                plan.name === 'professional' ? 'border-blue-500 ring-4 ring-blue-100' : 'border-gray-200'
            ...
            >
              ...
              <CardHeader className={`bg-gradient-to-r ${getPlanColor(plan.name)} text-white text-center py-8`}>
                ...
                <div className="space-y-4 mb-8">
                  <div className="flex items-center justify-between">
                    ...
                    <span className="font-bold text-blue-600">
                      {plan.calculations_limit === -1 ? 'Unlimited' : plan.calculations_limit}
                    </span>
                  </div>
        ...
        <div className="bg-white rounded-2xl shadow-xl p-8 mb-16">
          ...
          <div className="overflow-x-auto">
            <table className="w-full">
              ...
              <tbody>
                {[
                  { feature: 'Standard Cycle Analysis', free: true, pro: true, enterprise: true },
                  { feature: 'Refrigerant Comparison', free: false, pro: true, enterprise: true },
                  { feature: 'Cascade Cycle Analysis', free: false, pro: true, enterprise: true },
                  { feature: 'Calculation History', free: false, pro: true, enterprise: true },
                  { feature: 'Export to PDF/Excel', free: false, pro: true, enterprise: true },
        ...
        <div className="text-center bg-gradient-to-r from-blue-600 to-purple-600 rounded-2xl p-12 text-white">
          ...
          <p className="text-xl mb-8 opacity-90">
            Join thousands of engineers using Simulateon for professional HVAC&R calculations.
          </p>
