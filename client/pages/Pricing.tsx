...
export default function Pricing() {
  ...
  return (
    <div className="min-h-screen w-full bg-slate-50 px-4 py-8 md:py-12">
      <div className="mx-auto max-w-5xl">
        ...
        <div className="text-center">
          ...
          <div className="grid gap-8 md:grid-cols-2 lg:gap-12 mt-16">
            {/* Free Plan */}
            <Card className="relative flex flex-col border-slate-200 shadow-sm transition-all hover:shadow-md">
              <CardHeader>
            ...
            {/* Pro Plan */}
            <Card className="relative flex flex-col border-blue-200 bg-blue-50/50 shadow-lg ring-1 ring-blue-200 transition-all hover:shadow-xl overflow-visible">
