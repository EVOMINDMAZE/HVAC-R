        ...
        try {
            ...
            if (!companyId) {
                ...
                if (createCompanyError) {
                    ...
                    throw new Error(`Company Creation Failed: ${createCompanyError.message}`);
                }
        ...
        <div className="min-h-screen bg-slate-50 dark:bg-slate-950 transition-colors duration-300">
            ...
            <PageContainer variant="standard">
                ...
                <div className="flex flex-col md:flex-row md:items-center justify-between gap-6 mb-12">
                    ...
                    >
                        <div className="flex items-center gap-2 mb-2 text-blue-600 font-medium tracking-wide">
                    ...
                    >
                        <Dialog open={isDialogOpen} onOpenChange={setIsDialogOpen}>
                            <DialogTrigger asChild>
                                <Button className="bg-blue-600 hover:bg-blue-700 text-white px-6 h-12 rounded-xl shadow-lg shadow-blue-500/20 transition-all flex items-center gap-2 group">
                            ...
                            <DialogContent className="sm:max-w-[425px] rounded-3xl">
                                ...
                                <div className="grid gap-6 py-4">
                                    ...
                                    <div className="grid gap-2">
                                        <Label htmlFor="address" className="text-sm font-semibold text-gray-700">Service Address</Label>
                                        <Input
                                            id="address"
                ...
                <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6 mb-12">
                    {[
                        ...
                        { label: "Active This Month", value: "12", icon: BarChart3, color: "indigo" },
                        { label: "Pending Follow-ups", value: "5", icon: Clock, color: "orange" },
                        { label: "Verified Profiles", value: "98%", icon: ShieldCheck, color: "emerald" }
                    ].map((stat, i) => (
                        <motion.div
                            key={stat.label}
                                ...
                                >
                                    <Card className="h-full rounded-[2rem] border-gray-100 dark:border-slate-800 bg-white dark:bg-slate-900 shadow-sm hover:shadow-xl hover:shadow-blue-500/5 transition-all duration-300 overflow-hidden relative group">
                                        ...
                                        <CardHeader className="pb-4">
                                            <div className="w-16 h-16 rounded-3xl bg-gradient-to-br from-blue-500 to-indigo-600 flex items-center justify-center text-white mb-6 shadow-lg shadow-blue-200">
