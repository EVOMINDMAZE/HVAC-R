...
export default function CompanySettings() {
  ...
  // Legacy n8n config removed - automations now use Supabase Edge Functions
      ...
      try {
        ...
        if (data) {
          ...
          if (data.alert_config) {
            if (data.alert_config.message)
              setAlertMessage(data.alert_config.message);
            if (data.alert_config.invoice_chaser_enabled !== undefined)
              setInvoiceChaserEnabled(data.alert_config.invoice_chaser_enabled);
            // Check legacy or new structure for Review Hunter
            if (
              data.alert_config.workflows?.review_request?.email === false &&
              data.alert_config.workflows?.review_request?.sms === false
            ) {
          ...
          // n8n config loading removed - automations now use Edge Functions
  ...
  const handleSave = async () => {
    ...
    try {
      ...
      const updates = {
        ...
        // n8n_config removed - automations now use Edge Functions
      ...
      <div className="max-w-4xl mx-auto">
        ...
        <Card>
          ...
          <CardContent className="space-y-6">
            ...
            <div className="space-y-4 pt-4 border-t">
              ...
              <div className="pt-2">
                ...
                <p className="text-xs text-slate-500 italic mt-4">
                  Note: Client-specific notification preferences (e.g. Opt-out)
            ...
            {/* Automation Server Config - Removed (migrated to Supabase Edge Functions) */}
