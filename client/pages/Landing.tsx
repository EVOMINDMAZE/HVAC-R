...
function HeroSection() {
  ...
  return (
    <section
      ref={targetRef}
      className="relative pt-32 pb-20 lg:pt-48 lg:pb-32 overflow-hidden px-4"
    >
      <motion.div
      ...
      >
        ...
        >
          <motion.div variants={fadeInUp}>
            <Badge
              variant="outline"
              className="px-4 py-1.5 rounded-full border-orange-500/30 bg-orange-500/10 text-orange-600 dark:text-orange-400 mb-8 backdrop-blur-md"
            >
          ...
          >
            ...
            <span className="text-transparent bg-clip-text bg-gradient-to-r from-slate-700 via-orange-500 to-amber-500 animate-gradient-x">
          ...
          >
            The comprehensive platform for HVAC&R professionals. Simulate,
            analyze, and optimize simple to complex thermodynamic systems with
            unprecedented speed.
          </motion.p>
          ...
          >
            <Link to="/signup" className="w-full sm:w-auto">
              <Button
                size="lg"
                className="w-full sm:w-auto bg-orange-600 hover:bg-orange-700 text-white h-14 px-8 rounded-full shadow-xl shadow-orange-500/20 transition-all hover:scale-105 font-medium text-lg"
              >
                Start Free Trial
      ...
      <div className="absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 w-[1000px] h-[600px] bg-gradient-to-tr from-orange-500/20 via-amber-500/10 to-transparent rounded-[100%] blur-[120px] -z-10 opacity-60 dark:opacity-40 pointer-events-none" />
    </section>
  );
}
    ...
    <section className="py-24 px-4 relative z-10 overflow-hidden">
      <div className="max-w-6xl mx-auto">
        ...
        >
          <Badge
            variant="secondary"
            className="mb-4 bg-orange-100 text-orange-700 dark:bg-orange-900/30 dark:text-orange-300"
          >
            Interactive Preview
          </Badge>
          ...
          <p className="text-muted-foreground text-lg max-w-2xl mx-auto">
            Try the interactive dashboard below. See how ThermoNeural visualizes
            complex thermodynamic data.
          </p>
        </motion.div>
            ...
            <div className="flex-1 flex flex-col min-w-0 bg-slate-950/50">
              ...
              <div className="h-16 border-b border-slate-800 flex items-center justify-between px-6 bg-slate-900/20 backdrop-blur-sm">
                ...
                <div className="flex items-center gap-4">
                  <div className="h-8 w-8 rounded-full bg-gradient-to-tr from-orange-500 to-amber-500 border border-white/10" />
                </div>
              </div>
                      ...
                      {[
                        ...
                        >
                          ...
                          <div className="flex items-end justify-between">
                            ...
                            <div
                              className={`text-xs font-medium ${stat.color} bg-white/5 px-2 py-1 rounded`}
                            >
                              {stat.trend}
                            </div>
                          </div>
                    ...
                    <div className="flex-1 rounded-xl bg-slate-900 border border-slate-800 p-4 min-h-0 flex flex-col items-center justify-center text-center space-y-4 relative overflow-hidden">
                      ...
                      <div className="relative z-10 max-w-md">
                        ...
                        <p className="text-slate-400">
                          Connect your equipment sensors to visualize
                          pressure-enthalpy diagrams, temperature curves, and
                          efficiency metrics instantly.
                        </p>
                      </div>
                ...
                {activeTab !== "overview" && (
                  ...
                  >
                    ...
                    <p className="text-sm max-w-xs text-center mt-2">
                      Sign up to access full {activeTab} features interactively.
                    </p>
...
function FeatureCard({
  ...
  return (
    <motion.div
      ...
      className="group p-8 rounded-3xl bg-slate-50 dark:bg-slate-900/50 border border-slate-200 dark:border-slate-800 hover:border-orange-500/50 hover:bg-white dark:hover:bg-slate-800 transition-all duration-300 relative overflow-hidden"
    >
    ...
    <section className="py-32 px-4 bg-slate-50/50 dark:bg-slate-950/50 border-y border-slate-200 dark:border-slate-800">
      <div className="max-w-[1600px] mx-auto">
        <div className="text-center mb-20 max-w-3xl mx-auto">
          <Badge
            variant="outline"
            className="mb-4 border-orange-200 bg-orange-50 text-orange-700 dark:bg-orange-950/30 dark:border-orange-800 dark:text-orange-300"
          >
            Feature Rich Platform
          </Badge>
          <h2 className="text-3xl md:text-5xl font-bold text-foreground mb-6">
            Everything you need for{" "}
            <span className="text-orange-600">thermal analysis</span>
          </h2>
          <p className="text-lg text-muted-foreground">
            From quick estimations to detailed system design, ThermoNeural
            provides the tools engineering teams trust.
          </p>
        </div>
    ...
    <section className="py-32 px-4">
      <div className="max-w-5xl mx-auto">
        <div className="relative rounded-[2.5rem] bg-gradient-to-br from-slate-900 to-slate-800 px-6 py-20 md:px-20 text-center overflow-hidden shadow-2xl">
          {/* Background Glows */}
          <div className="absolute top-0 right-0 w-96 h-96 bg-orange-500/20 blur-[120px] rounded-full pointer-events-none" />
          <div className="absolute bottom-0 left-0 w-96 h-96 bg-amber-500/20 blur-[120px] rounded-full pointer-events-none" />
          ...
          <div className="relative z-10">
            ...
            <p className="text-lg text-slate-300 mb-10 max-w-2xl mx-auto">
              Join the platform designed for the modern thermodynamics
              professional. Start for free, upgrade as you grow.
            </p>
            <div className="flex flex-col sm:flex-row gap-4 justify-center">
              <Link to="/signup">
                <Button
                  size="lg"
                  className="w-full sm:w-auto h-14 px-8 text-lg bg-white text-slate-900 hover:bg-slate-100 border-0 font-semibold"
                >
...
export function Landing() {
  return (
    <div className="min-h-screen w-full bg-background text-foreground selection:bg-orange-100 selection:text-orange-900 flex flex-col">
