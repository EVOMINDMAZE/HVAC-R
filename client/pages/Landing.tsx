      ...
      <section className="max-w-7xl mx-auto px-4 py-20">
        ...
        <div className="grid md:grid-cols-3 gap-8 mb-20">
          <Card className="bg-white/60 backdrop-blur-sm border-blue-200 hover:shadow-lg transition-all duration-300">
            ...
            <CardContent className="text-center">
              <p className="text-gray-600">
                Calculate COP, refrigeration effect, and state points for
          ...
          <Card className="bg-white/60 backdrop-blur-sm border-blue-200 hover:shadow-lg transition-all duration-300">
            ...
            <CardContent className="text-center">
              <p className="text-gray-600">
                Compare performance metrics across multiple refrigerants to
          ...
          <Card className="bg-white/60 backdrop-blur-sm border-blue-200 hover:shadow-lg transition-all duration-300">
            ...
            <CardContent className="text-center">
              <p className="text-gray-600">
                Analyze complex two-stage cascade refrigeration systems for
      ...
      <section className="max-w-7xl mx-auto px-4 py-20 text-center">
        <div className="bg-gradient-to-r from-blue-600 to-purple-600 rounded-2xl p-12 text-white">
          ...
          <p className="text-xl mb-8 opacity-90">
            Join thousands of engineers using Simulateon for their refrigeration
            calculations.
          </p>
          <div className="flex flex-col sm:flex-row gap-4 justify-center">
            <Link to="/signup">
