  ...
  return (
    <div className="min-h-screen bg-background text-foreground selection:bg-orange-500/30">
      ...
      <main className="flex-grow pt-24 px-4 relative overflow-hidden pb-20">
        ...
        <div className="absolute bottom-[20%] right-[-10%] w-[500px] h-[500px] bg-orange-500/10 rounded-full blur-[100px] pointer-events-none" />
        ...
        <div className="max-w-[1600px] mx-auto">
            ...
            <>
              ...
              {featuredPost && (
                <motion.div
                  ...
                  className="mb-16"
                >
                  <Card className="bg-card/50 backdrop-blur-md shadow-xl border-border overflow-hidden group hover:border-orange-500/30 transition-colors duration-300">
                    <div className="grid md:grid-cols-2 gap-0">
                      <div className="p-8 md:p-12 flex flex-col justify-center">
                        <div className="flex items-center space-x-3 mb-6">
                          <Badge className="bg-orange-100 dark:bg-orange-900/30 text-orange-700 dark:text-orange-300 hover:bg-orange-200 border-none">
                        ...
                        <h2 className="text-3xl md:text-4xl font-bold mb-6 text-foreground group-hover:text-orange-600 dark:group-hover:text-orange-400 transition-colors">
                          {featuredPost.title}
                        </h2>
                        ...
                        <div className="flex flex-wrap items-center text-sm text-muted-foreground mb-8 gap-4">
                          ...
                          <div className="flex items-center">
                            <Clock className="h-4 w-4 mr-2 text-orange-500" />5
                            min read
                          </div>
                        </div>
                        ...
                        >
                          <Button className="w-fit bg-orange-600 hover:bg-orange-700 text-white rounded-full px-8 group-hover:shadow-lg group-hover:shadow-orange-500/25 transition-all">
                            Read Case Study{" "}
              ...
              <div className="mb-12">
                <h3 className="text-2xl font-bold mb-8 flex items-center">
                  <span className="w-1 h-8 bg-orange-600 mr-4 rounded-full"></span>
                  Latest Articles
                </h3>
                ...
                >
                  {regularPosts.map((post) => (
                    <motion.div key={post._id} variants={itemVariants}>
                      <Card className="h-full bg-card/50 backdrop-blur-sm hover:shadow-lg hover:border-orange-500/30 transition-all duration-300 group flex flex-col overflow-hidden">
                        ...
                        <CardHeader>
                          ...
                          <CardTitle className="text-xl group-hover:text-orange-600 dark:group-hover:text-orange-400 transition-colors line-clamp-2">
                            {post.title}
                          </CardTitle>
                        </CardHeader>
                        <CardContent className="flex-grow flex flex-col justify-between">
                          ...
                          >
                            <Button
                              variant="ghost"
                              className="w-full justify-between hover:bg-orange-50 dark:hover:bg-orange-900/20 group/btn"
                            >
                              Read Article
                              <ArrowRight className="h-4 w-4 group-hover/btn:translate-x-1 transition-transform text-orange-500" />
                            </Button>
                          </Link>
                        </CardContent>
                      </Card>
          ...
          <div className="mt-24 bg-gradient-to-r from-orange-900/20 to-slate-900/20 rounded-3xl p-1 relative overflow-hidden">
            ...
            <div className="bg-card/40 backdrop-blur-xl rounded-[20px] p-8 md:p-12 text-center relative z-10">
              <span className="inline-block p-3 rounded-2xl bg-orange-500/10 mb-6">
              ...
              <div className="flex flex-col sm:flex-row gap-4 max-w-md mx-auto">
                <input
                  ...
                  className="flex-grow px-4 py-3 rounded-lg bg-background/50 border border-border focus:ring-2 focus:ring-orange-500 outline-none transition-all"
                />
