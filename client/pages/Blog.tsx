...
const blogPosts = [
  {
    ...
    excerpt:
      "A comprehensive guide to the upcoming R-410A phase-out and what it means for HVAC system design.",
  ...
  },
  {
    id: 2,
    title:
      "Optimizing Cascade Refrigeration Systems for Industrial Applications",
    excerpt:
      "Best practices for designing efficient cascade systems with CO₂ and conventional refrigerants.",
  ...
  },
  {
    ...
    excerpt:
      "Exploring the benefits and challenges of implementing natural refrigerants in modern systems.",
  ...
  },
  {
    ...
    excerpt:
      "Advanced techniques for maximizing efficiency in commercial heat pump applications.",
  ...
  },
  {
    ...
    excerpt:
      "Deep dive into advanced property calculation methods for complex refrigerant mixtures.",
    author: "Lisa Park",
    date: "2023-12-20",
      ...
      <div className="max-w-7xl mx-auto px-4 py-16">
        ...
        <div className="text-center mb-16">
          ...
          <p className="text-xl text-gray-600 max-w-3xl mx-auto leading-relaxed">
            ...
            practices in HVAC&R engineering and refrigeration systems.
          </p>
        </div>
        ...
        <Card className="bg-gradient-to-r from-blue-600 to-purple-600 text-white">
          <CardContent className="p-8 text-center">
            ...
            <p className="text-blue-100 mb-6 max-w-2xl mx-auto">
              Subscribe to our newsletter for the latest insights in HVAC&R
              engineering, new tool releases, and industry updates.
            </p>
