        ...
        <div className="bg-white rounded-lg shadow-lg p-8 space-y-8">
          ...
          <section>
            ...
            <p className="text-gray-700 mb-4">
              ...
              materials (information or software) on Simulateon's website for
          ...
          <section>
            ...
            <p className="text-gray-700 mb-4">
              The materials on Simulateon's website are provided on an "as-is"
              basis. Simulateon makes no warranties, expressed or implied, and
            ...
            <p className="text-gray-700">
              ...
              Simulateon does not warrant the accuracy or completeness of the
          ...
          <section>
            ...
            <p className="text-gray-700">
              In no event shall Simulateon or its suppliers be liable for
              damages (including, without limitation, damages for loss of data
              or profit, or due to business interruption) arising out of the use
              or inability to use the materials on Simulateon's website, even if
              Simulateon or an authorized representative has been notified
          ...
          <section>
            ...
            <p className="text-gray-700">
              The materials appearing on Simulateon's website could include
              technical, typographical, or photographic errors. Simulateon does
              not warrant that any of the materials on its website are accurate,
              complete, or current. Simulateon may make changes to the materials
          ...
          <section>
            ...
            <p className="text-gray-700">
              Simulateon has not reviewed all of the sites linked to its website
              and is not responsible for the contents of any such linked site.
              The inclusion of any link does not imply endorsement by Simulateon
          ...
          <section>
            ...
            <p className="text-gray-700">
              Simulateon may revise these terms of service for its website at
          ...
          <section>
            ...
            <p className="text-gray-700">
              ...
              on Simulateon's website are the property of Simulateon or its
          ...
          <section>
            ...
            <p className="text-gray-700">
              Simulateon may terminate or suspend your account and access to the
