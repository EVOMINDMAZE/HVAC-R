...
> = {
  ...
  Goodman: {
    ...
    note: "Goodman Serial Lookup",
    color: "bg-slate-800",
  },
  Lennox: {
    url: "https://www.lennox.com/registration",
    note: "Lennox Product Check",
    color: "bg-red-700",
  },
  Rheem: {
    url: "https://www.rheem.com/warranty/product-warranty-lookup/",
    note: "Rheem/Ruud Integration",
    color: "bg-red-500",
  },
  Ruud: {
    url: "https://www.ruud.com/warranty/product-warranty-lookup/",
    note: "Rheem/Ruud Integration",
    color: "bg-red-500",
  },
  Daikin: {
...
export default function WarrantyScanner() {
  ...
  const extractInfo = (text: string) => {
    ...
    const foundBrand =
      Object.keys(MANUFACTURER_PORTALS).find((brand) =>
        ...
        <div className="flex justify-between items-center mb-8">
          <div>
            ...
            <p className="text-slate-500 font-medium">
              Smart OCR & Manufacturer Lifecycle Portal
            </p>
          </div>
        </div>
                ...
                <div className="relative w-full h-full">
                  ...
                  {!scanning && (
                    <Button
                      onClick={reset}
                      variant="secondary"
                      className="absolute top-4 right-4 rounded-full px-6 bg-black/50 text-white backdrop-blur-xl border-white/20"
                    >
            ...
            <Card className="border-none shadow-2xl rounded-3xl overflow-hidden ring-1 ring-slate-200 dark:ring-slate-800">
              <CardHeader className="pb-2">
                <div className="flex justify-between items-center mb-2">
                  ...
                  {extractedData.manufacturer && (
                    <Badge
                      className={`${portalInfo?.color || "bg-slate-600"} text-white`}
                    >
                      {extractedData.manufacturer}
                    </Badge>
                  )}
                ...
                <CardDescription>
                  Data extracted via Tesseract Neural Engine.
                </CardDescription>
              </CardHeader>
              ...
              <CardContent className="space-y-6 pt-6">
                  ...
                  <div className="space-y-2">
                    ...
                    <div className="flex gap-2">
                      ...
                      <Button
                        ...
                        className="h-12 w-12"
                        onClick={() =>
                          copyToClipboard(extractedData.serialNumber, "S/N")
                        }
                      >
                  ...
                  <div className="space-y-2">
                    ...
                    <div className="flex gap-2">
                      ...
                      <Button
                        ...
                        className="h-12 w-12"
                        onClick={() =>
                          copyToClipboard(extractedData.modelNumber, "M/N")
                        }
                      >
                ...
                <div className="p-4 bg-slate-900 rounded-2xl space-y-4">
                  ...
                  >
                    {portalInfo
                      ? `Open ${extractedData.manufacturer} Portal`
                      : "Global Warranty Search"}
                  </Button>
                  <p className="text-[10px] text-slate-400 text-center uppercase font-bold tracking-widest">
                    Portal will open in new tab. Use copy buttons above for form
                    entry.
                  </p>
                </div>
