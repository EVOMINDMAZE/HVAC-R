...
export function ProfessionalFeatures({
  ...
  return (
    <div className="space-y-6">
      ...
      <Card className="border-2 border-orange-200 dark:border-orange-900/50 bg-gradient-to-r from-orange-50 to-slate-50 dark:from-slate-900 dark:to-slate-800">
        <CardHeader>
          ...
          <div className="grid grid-cols-1 md:grid-cols-4 gap-4 mt-4">
            <div className="text-center p-3 bg-white dark:bg-slate-800 rounded-lg border dark:border-slate-700">
              <Users className="h-5 w-5 mx-auto text-orange-600 dark:text-orange-400 mb-1" />
            ...
            <div className="text-center p-3 bg-white dark:bg-slate-800 rounded-lg border dark:border-slate-700">
              <Calculator className="h-5 w-5 mx-auto text-green-600 dark:text-green-400 mb-1" />
            ...
            <div className="text-center p-3 bg-white dark:bg-slate-800 rounded-lg border dark:border-slate-700">
              <Briefcase className="h-5 w-5 mx-auto text-slate-600 dark:text-slate-400 mb-1" />
            ...
            <div className="text-center p-3 bg-white dark:bg-slate-800 rounded-lg border dark:border-slate-700">
              <Target className="h-5 w-5 mx-auto text-orange-600 dark:text-orange-400 mb-1" />
              ...
              <CardContent>
                {costData ? (
                  <div className="space-y-4">
                    ...
                    <div className="p-3 bg-slate-50 dark:bg-slate-900/10 border border-slate-200 dark:border-slate-900/30 rounded-lg">
        ...
        <TabsContent value="reports">
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
            ...
            <Card>
              ...
              <CardContent className="space-y-4">
                <div className="p-4 bg-gradient-to-r from-orange-50 to-slate-50 dark:from-slate-900 dark:to-slate-800 border border-orange-200 dark:border-orange-900/30 rounded-lg">
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
                  ...
                  <div className="space-y-3">
                    ...
                    <div className="space-y-2 text-sm">
                      {cop && (
                        <div className="p-2 bg-yellow-50 dark:bg-yellow-900/10 border border-yellow-200 dark:border-yellow-900/30 rounded">
                  ...
                  <div className="space-y-3">
                    ...
                    <div className="space-y-2 text-sm">
                      <div className="p-2 bg-green-50 dark:bg-green-900/10 border border-green-200 dark:border-green-900/30 rounded">
                  ...
                  <div className="space-y-3">
                    ...
                    <div className="space-y-2 text-sm">
                      {costData && (
                        <div className="p-2 bg-orange-50 dark:bg-orange-900/10 border border-orange-200 dark:border-orange-900/30 rounded">
