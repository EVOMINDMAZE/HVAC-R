...
export function ProfessionalFeatures({
  ...
  return (
    <div className="space-y-6">
      ...
      <Card className="border-2 border-blue-200 dark:border-blue-900/50 bg-gradient-to-r from-blue-50 to-indigo-50 dark:from-slate-900 dark:to-slate-800">
        <CardHeader>
          ...
          <div className="grid grid-cols-1 md:grid-cols-4 gap-4 mt-4">
            ...
            <div className="text-center p-3 bg-white dark:bg-slate-800 rounded-lg border dark:border-slate-700">
              <Briefcase className="h-5 w-5 mx-auto text-purple-600 dark:text-purple-400 mb-1" />
        ...
        <TabsContent value="reports">
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
            ...
            <Card>
              ...
              <CardContent className="space-y-4">
                <div className="p-4 bg-gradient-to-r from-blue-50 to-indigo-50 dark:from-slate-900 dark:to-slate-800 border border-blue-200 dark:border-blue-900/30 rounded-lg">
                  <h4 className="font-semibold text-blue-800 dark:text-blue-100 mb-2">
              ...
              <CardContent>
                <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
                  ...
                  <div className="space-y-3">
                    ...
                    <div className="space-y-2 text-sm">
                      {costData && (
                        <div className="p-2 bg-blue-50 dark:bg-blue-900/10 border border-blue-200 dark:border-blue-900/30 rounded">
