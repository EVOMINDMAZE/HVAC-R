...
export function ProfessionalFeatures({
  ...
  const generateReport = () => {
    ...
    const reportContent = `# ${reportData.header.title}\n\n` +
      ...
      `Executive Summary:\nThis report contains detailed thermodynamic results, cost analysis, and recommendations.\n\n` +
      ...
      `Cost Analysis:\n${costData ? `Annual Energy Cost: $${costData.annualEnergyCost?.toFixed(2) || "N/A"}\nTotal Lifetime Cost: $${costData.totalLifetimeCost?.toFixed(2) || "N/A"}\nPayback Period: ${costData.paybackPeriod?.toFixed(1) || "N/A"} years\n` : 'Cost analysis not available\n'}\n` +
      `Sustainability:\n- GWP: ${sustainabilityData.gwp}\n- ODP: ${sustainabilityData.odp}\n- Alternatives: ${sustainabilityData.alternative}\n\n` +
      `Recommendations:\n- ${generateRecommendations().join('\n- ')}\n\n` +
      `Raw Calculations (JSON) included as an attachment with the report.\n`;
