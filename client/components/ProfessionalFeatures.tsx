                  ...
                  <div className="space-y-4">
                    <div className="grid grid-cols-2 gap-4">
                      <div className="p-3 bg-green-50 border border-green-200 rounded-lg">
                        <div className="text-2xl font-bold text-green-600">
                          ${costData.annualEnergyCost.toFixed(0)}
                        </div>
                    ...
                    <div className="space-y-2">
                      <div className="flex justify-between">
                        ...
                        <span className="font-semibold">${costData.lifetimeEnergyCost.toFixed(0)}</span>
                      </div>
                      <div className="flex justify-between">
                        <span>Annual Maintenance:</span>
                        <span className="font-semibold">${costData.annualMaintenanceCost.toFixed(0)}</span>
                      </div>
                      <div className="flex justify-between">
                        <span>Total Lifetime Cost:</span>
                        <span className="font-semibold">${costData.totalLifetimeCost.toFixed(0)}</span>
                      </div>
                      <div className="flex justify-between">
                        <span>Energy Consumption:</span>
                        <span className="font-semibold">{costData.annualEnergyConsumption.toFixed(0)} kWh/year</span>
                      </div>
                    </div>
                    ...
                    <div className="p-3 bg-purple-50 border border-purple-200 rounded-lg">
                      ...
                      <div className="text-sm text-purple-700 mt-1">
                        Operating cost represents {((costData.annualEnergyCost / costAnalysis.initialCost) * 100).toFixed(1)}% 
                    ...
                    <div className="space-y-2 text-sm">
                      {results?.performance?.cop && (
                        <div className="p-2 bg-yellow-50 border border-yellow-200 rounded">
                          Current COP: {results.performance.cop.toFixed(2)}
                    ...
                    <div className="space-y-2 text-sm">
                      {costData && (
                        <div className="p-2 bg-blue-50 border border-blue-200 rounded">
                          Annual Operating Cost: ${costData.annualEnergyCost.toFixed(0)}
                          <div className="text-xs text-muted-foreground">
                            {costData.efficiency > 75 ? 'Cost-effective operation' : 'Consider efficiency upgrades'}
                          </div>
                        </div>
                      )}
                      <ul className="space-y-1 text-muted-foreground">
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                  <div>
                    ...
                    <div className="space-y-2 text-sm">
                      {results?.performance && (
                        <div className="space-y-1">
                          <div>Evaporator: {(results.performance.cooling_capacity_kw * 1.1).toFixed(1)} kW capacity</div>
                          <div>Condenser: {(results.performance.heat_rejection_kw * 1.05).toFixed(1)} kW capacity</div>
                          <div>Compressor: {results.performance.compressor_work_kw.toFixed(1)} kW minimum power</div>
                        </div>
                      )}
                    </div>
                  </div>
