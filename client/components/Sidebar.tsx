            ...
            <DropdownMenu>
              ...
              <DropdownMenuContent align="start" className="w-80 p-2 bg-white/95 dark:bg-slate-950/95 backdrop-blur-xl border border-slate-200 dark:border-slate-800 animate-in fade-in-0 zoom-in-95">
                ...
                {calculators.items.map((navItem) => {
                  ...
                  return (
                    <DropdownMenuItem key={navItem.to} asChild className="cursor-pointer focus:bg-slate-50 dark:focus:bg-slate-800/50 my-1">
                      <Link to={navItem.to} className="flex items-center gap-3 w-full p-2">
                        ...
                        <div className="flex flex-col">
                          ...
                          <span className="text-xs text-slate-500 dark:text-slate-400">{navItem.desc}</span>
                        </div>
                      </Link>
                    </DropdownMenuItem>
                  )
