...
export default function AirDensityCalculator({ saveCalculation }: AirDensityCalculatorProps) {
            ...
            <CardHeader className="bg-sky-50/50 dark:bg-slate-800/50 border-b border-sky-100 dark:border-slate-700 pb-4">
                <div className="flex items-center justify-between">
                    <div className="space-y-1">
                        ...
                        <CardDescription>
                            Calculate air density and equipment performance degradation at altitude.
                        </CardDescription>
                    </div>
                    ...
                    <div className="bg-slate-50/80 dark:bg-slate-900/50 p-6 md:p-8 flex flex-col justify-center items-center relative min-h-[300px]">
                        {result ? (
                            <div className="text-center w-full max-w-sm animate-in zoom-in-95 duration-300">
                                ...
                                <h3 className="text-sm font-semibold text-slate-500 uppercase tracking-widest mb-2">Air Density</h3>

                                <div className="flex items-baseline justify-center gap-1 mb-8">
                                    <span className="text-6xl font-black text-slate-900 dark:text-white tracking-tighter">
                                        {units === "imperial" ? result.densitylb.toFixed(3) : result.density.toFixed(3)}
                                    </span>
                                    <span className="text-lg text-slate-400 font-medium">{units === "imperial" ? "lb/ft³" : "kg/m³"}</span>
                                </div>
                                ...
                                <div className="grid grid-cols-2 gap-4 text-xs text-muted-foreground border-t border-slate-200 dark:border-slate-700 pt-6 mb-8">
                                    <div className="bg-red-50 dark:bg-red-900/10 p-2 rounded">
                                        <span className="block mb-1 text-red-600 dark:text-red-400 font-semibold">Capacity Loss</span>
                            ...
                            <div className="text-center text-slate-400 py-12">
                                <p className="max-w-[200px] mx-auto text-sm">Enter altitude and current conditions.</p>
                            </div>
                        )}
                    </div>
                </div>
