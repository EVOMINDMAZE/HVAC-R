...
describe('TargetSuperheatCalculator', () => {
  it('renders without crashing', () => {
    const { container } = renderWithRouter(<TargetSuperheatCalculator />);
    expect(container).toBeTruthy();
  });

  it('renders with saveCalculation prop', () => {
    const { container } = renderWithRouter(<TargetSuperheatCalculator saveCalculation={() => {}} />);
    expect(container).toBeTruthy();
  });
