        ...
        <CardContent className="flex flex-col items-center justify-center py-16 text-center space-y-4">
          ...
          <div className="max-w-md space-y-2">
            ...
            <p className="text-slate-500 dark:text-slate-400">
              Psychrometric calculations like Target Superheat and Air Density
              are available on the Solo plan and above.
            </p>
          </div>
          <Button className="mt-4 bg-gradient-to-r from-orange-600 to-slate-600 text-white shadow-lg hover:shadow-xl hover:from-orange-700 hover:to-slate-700 transition-all border-0">
            Upgrade to Unlock
          </Button>
        </CardContent>
      </Card>
    ...
    <div className="space-y-6">
      <Tabs defaultValue="superheat" className="w-full">
        ...
        <div className="mt-6">
          <TabsContent
            value="superheat"
            className="m-0 focus-visible:outline-none animate-in fade-in zoom-in-95 duration-300"
          >
