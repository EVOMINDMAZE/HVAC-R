...
interface EquipmentDiagramProps {
  type: 'compressor' | 'evaporator' | 'condenser' | 'expansion-valve' | 'heat-exchanger' | 'complete-cycle';
  width?: number;
  height?: number;
  showLabels?: boolean;
  animated?: boolean;
    ...
    switch (type) {
      case 'compressor':
        return (
          <svg width={width} height={height} viewBox="0 0 200 150" className={className}>
            {/* Compressor Body */}
            <rect x="50" y="40" width="100" height="70" rx="10" fill="#e5e7eb" stroke="#374151" strokeWidth="2"/>
            
            {/* Compressor Motor */}
            <circle cx="100" cy="75" r="25" fill="#6b7280" stroke="#374151" strokeWidth="2"/>
            
            {/* Suction Line */}
            <path d="M20 75 L50 75" stroke="#3b82f6" strokeWidth="4" fill="none"/>
            <polygon points="15,70 15,80 25,75" fill="#3b82f6"/>
            
            {/* Discharge Line */}
            <path d="M150 75 L180 75" stroke="#ef4444" strokeWidth="4" fill="none"/>
            ...
            {showLabels && (
              <>
                <text x="100" y="130" textAnchor="middle" className="text-sm font-medium fill-gray-700">
                  Compressor
                </text>
                <text x="35" y="95" textAnchor="middle" className="text-xs fill-blue-600">
                  Suction
                </text>
                <text x="165" y="95" textAnchor="middle" className="text-xs fill-red-600">
                  Discharge
                </text>
              </>
            )}
      ...
      case 'evaporator':
        return (
          <svg width={width} height={height} viewBox="0 0 200 150" className={className}>
            ...
            {animated && (
              <g fill="#60a5fa" opacity="0.6">
                ...
                <circle cx="80" cy="25" r="2">
                  <animate attributeName="cy" values="25;125;25" dur="3s" begin="0.5s" repeatCount="indefinite"/>
                </circle>
                <circle cx="120" cy="30" r="2">
                  <animate attributeName="cy" values="30;120;30" dur="3s" begin="1s" repeatCount="indefinite"/>
                </circle>
                <circle cx="160" cy="25" r="2">
                  <animate attributeName="cy" values="25;125;25" dur="3s" begin="1.5s" repeatCount="indefinite"/>
                </circle>
              </g>
            )}
            ...
            {showLabels && (
              <text x="110" y="140" textAnchor="middle" className="text-sm font-medium fill-gray-700">
                Evaporator
              </text>
            )}
          </svg>
      ...
      case 'condenser':
        return (
          <svg width={width} height={height} viewBox="0 0 200 150" className={className}>
            ...
            {/* Fan */}
            <g>
              <circle cx="110" cy="25" r="15" fill="none" stroke="#374151" strokeWidth="2"/>
              <g fill="#374151">
            ...
            {animated && (
              <g fill="#fbbf24" opacity="0.6">
                <circle cx="70" cy="10" r="2">
                  <animate attributeName="cy" values="10;-10" dur="2s" repeatCount="indefinite"/>
                  <animate attributeName="opacity" values="0.6;0" dur="2s" repeatCount="indefinite"/>
                </circle>
                <circle cx="110" cy="5" r="2">
                  <animate attributeName="cy" values="5;-15" dur="2s" begin="0.5s" repeatCount="indefinite"/>
                  <animate attributeName="opacity" values="0.6;0" dur="2s" begin="0.5s" repeatCount="indefinite"/>
                </circle>
                <circle cx="150" cy="10" r="2">
                  <animate attributeName="cy" values="10;-10" dur="2s" begin="1s" repeatCount="indefinite"/>
      ...
      case 'expansion-valve':
        return (
          <svg width={width} height={height} viewBox="0 0 200 150" className={className}>
            {/* Valve Body */}
            <rect x="80" y="60" width="40" height="30" fill="#d1d5db" stroke="#374151" strokeWidth="2"/>
            
            {/* Inlet Pipe */}
            <rect x="30" y="70" width="50" height="10" fill="#6b7280" stroke="#374151" strokeWidth="1"/>
            
            {/* Outlet Pipe */}
            <rect x="120" y="70" width="50" height="10" fill="#6b7280" stroke="#374151" strokeWidth="1"/>
            
            {/* Restriction */}
            <path d="M80 75 L95 70 L95 80 L105 70 L105 80 L120 75" 
                  fill="none" stroke="#374151" strokeWidth="2"/>
            
            {/* Control Element */}
            <rect x="95" y="45" width="10" height="15" fill="#374151"/>
            <circle cx="100" cy="40" r="8" fill="#9ca3af" stroke="#374151" strokeWidth="2"/>
            ...
            {showLabels && (
              <>
                ...
                <text x="55" y="95" textAnchor="middle" className="text-xs fill-red-600">
                  High P
                </text>
                <text x="145" y="95" textAnchor="middle" className="text-xs fill-blue-600">
                  Low P
                </text>
              </>
            )}
      ...
      case 'complete-cycle':
        return (
          <svg width={width} height={height} viewBox="0 0 400 300" className={className}>
            {/* Complete Refrigeration Cycle */}
            
            {/* Evaporator */}
            <g transform="translate(50, 200)">
              <rect width="100" height="40" fill="#e5f3ff" stroke="#3b82f6" strokeWidth="2" rx="5"/>
              <text x="50" y="25" textAnchor="middle" className="text-xs font-medium fill-blue-600">
                Evaporator
              </text>
            </g>
            ...
            <g transform="translate(300, 200)">
              <circle cx="25" cy="20" r="20" fill="#fef3c7" stroke="#f59e0b" strokeWidth="2"/>
              <text x="25" y="50" textAnchor="middle" className="text-xs font-medium fill-yellow-600">
                Compressor
              </text>
            </g>
            ...
            <g transform="translate(250, 50)">
              <rect width="100" height="40" fill="#fef2f2" stroke="#ef4444" strokeWidth="2" rx="5"/>
              <text x="50" y="25" textAnchor="middle" className="text-xs font-medium fill-red-600">
                Condenser
              </text>
            </g>
            ...
            <g transform="translate(50, 50)">
              <polygon points="0,20 20,10 20,30" fill="#f3f4f6" stroke="#6b7280" strokeWidth="2"/>
              <text x="10" y="50" textAnchor="middle" className="text-xs font-medium fill-gray-600">
                Expansion
              </text>
            </g>
            ...
            <g className="text-xs font-bold">
              <circle cx="225" cy="220" r="5" fill="#fff" stroke="#000" strokeWidth="2"/>
              <text x="225" y="235" textAnchor="middle">1</text>
              
              <circle cx="325" cy="145" r="5" fill="#fff" stroke="#000" strokeWidth="2"/>
              <text x="340" y="150" textAnchor="middle">2</text>
              
              <circle cx="160" cy="70" r="5" fill="#fff" stroke="#000" strokeWidth="2"/>
              <text x="160" y="55" textAnchor="middle">3</text>
              
              <circle cx="50" cy="135" r="5" fill="#fff" stroke="#000" strokeWidth="2"/>
              <text x="35" y="140" textAnchor="middle">4</text>
            </g>
          </svg>
        );
      ...
      default:
        return (
          <svg width={width} height={height} viewBox="0 0 200 150" className={className}>
            ...
            <text x="100" y="75" textAnchor="middle" className="text-sm fill-gray-500">
              Equipment Diagram
            </text>
          </svg>
        );
...
export function EquipmentLibrary() {
  const equipmentTypes = [
    { type: 'compressor' as const, name: 'Compressor', description: 'Increases refrigerant pressure and temperature' },
    { type: 'evaporator' as const, name: 'Evaporator', description: 'Absorbs heat from surroundings' },
    { type: 'condenser' as const, name: 'Condenser', description: 'Rejects heat to surroundings' },
    { type: 'expansion-valve' as const, name: 'Expansion Valve', description: 'Reduces pressure and temperature' },
    { type: 'complete-cycle' as const, name: 'Complete Cycle', description: 'Full refrigeration system' }
  ];
